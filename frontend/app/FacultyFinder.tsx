          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              <input
                ...
                className="w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-3 text-gray-100 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-inner"
              />
          ...
          <div className="flex flex-col">
            ...
            <div className="relative">
              <select
                ...
                className="w-full bg-gray-900 border border-gray-600 rounded-lg px-4 py-3 appearance-none text-gray-100 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent cursor-pointer shadow-inner transition-all"
              >
                ...
                <div className="flex-grow space-y-2">
                  ...
                  {faculty.Email && (
                    <p className="text-sm text-gray-400 flex items-center">
                      ...
                      <a href={`mailto:${faculty.Email}`} className="hover:text-blue-400 transition-colors truncate">
                        {faculty.Email}
                      </a>
                    </p>
                  )}
